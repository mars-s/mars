...
/**
 * The Environment control-plane Endpoint scopes the Active/LKG cache path.
 * Switching Endpoint replaces the current Source and never reads the previous Endpoint cache.
 */
