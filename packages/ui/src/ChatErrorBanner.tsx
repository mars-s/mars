  ...
  return (
    <div className="flex w-full justify-center">
      ...
      >
        ...
        {modelConfigMissing ? (
          // The Z.ai coding-plan purchase entry point is gone, so the upgrade button that
          // gated it had no handler left to call. Opening model settings stays as the one
          // recovery path for "no model is configured", which is what this error actually means.
          <Button
            type="button"
            variant="outline"
            size="sm"
