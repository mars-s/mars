...
Commands:
  ...
  login <provider>  Sign in through browser authorization
...
`,
  ...
  tui: {
    ...
    loginRequired: {
      help: "Use /model to view models, or /login to sign in.",
    ...
    loginSetup: {
      ...
      prompt: "Choose a sign-in method.",
      response: "Choose where to sign in.",
      title: "Sign In",
    },
    model: {
